...
class AuthenticationHelper extends FingerprintManagerCompat.AuthenticationCallback
  ...
  private void showFingerprintDialog() {
    ...
    if(darTheme2) {
    // int color = Color.parseColor("#696969");
    // view.findViewById(R.id.main_layout).setBackgroundColor(6908265);
    view.findViewById(R.id.main_layout).setBackgroundColor(0x00696969);
